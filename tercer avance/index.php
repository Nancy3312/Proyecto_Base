        ...
        <article class="col1">
                ...
                <table class="formulario">
                    <tbody>
                        ...
                        <tr> -->                        
                            ...
                            <td colspan="2"><input class="Botton" name="agregar" type="submit" id="agregar" value="Agregar"/></td>
                        </tr>
                    </tbody>
                </table>
                <table width="745px">
	            	</tr>
	                    <td colspan="4" align="right"><a class='limpia'>Limpiar</a></td>
	                </tr>
            </form>
            <table id="grilla" class="lista mitabla">
              <thead>
                ...
                <tfoot>
                    <tr>
                        <td colspan="5" style="color:white;"><strong>Cantidad:</strong> <span id="span_cantidad"></span> Filas.</td>
                    </tr>
                </tfoot>
            </table>
            <hr />
